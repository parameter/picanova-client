...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PicanovaApi.SingleOrderPriceDetails();
  });
  ...
  describe('SingleOrderPriceDetails', function() {
    it('should create an instance of SingleOrderPriceDetails', function() {
      // uncomment below and update the code to test SingleOrderPriceDetails
      //var instance = new PicanovaApi.SingleOrderPriceDetails();
      //expect(instance).to.be.a(PicanovaApi.SingleOrderPriceDetails);
    });
